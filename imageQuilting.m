...
for i=1:net_patch:H_out-blocksize+1
    for j=1:net_patch:W_out-blocksize+1
        ...
        elseif i == 1
            block_h = texture_out(i_inds,i_prev:i_prev+blocksize-1);
            block_h3D = texture_out3D(i_inds,i_prev:i_prev+blocksize-1,:);
            ...
            [mask_h,mask_v] = getBoundary(block_h,-1,curr_patch,o,blocksize,flag);
        ...
        elseif j == 1
            ...
            [mask_h,mask_v] = getBoundary(-1,block_v,curr_patch,o,blocksize,flag);
            maskv3D = repmat(mask_v,[1,1,3]);
            ...
            [mask_h,mask_v] = getBoundary(block_h,block_v,curr_patch,o,blocksize,flag);
            mask_h3D = repmat(mask_h,[1,1,3]);
